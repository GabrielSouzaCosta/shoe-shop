    ...
    <div className="card w-75 pb-3">
          ...
          <div className="row justify-content-center text-dark">
            <div className="col-8">
              ...
              <Form.Control id="email" className="border border-2 border-dark" placeholder="youremail@email.com" /> 
            </div>
            <div className="col-8 mt-1">
              <Form.Label htmlFor="email" className="fs-3">
                Password
              </Form.Label>
              <Form.Control id="email" className="border border-2 border-dark" placeholder="yourpassword..."/>
            </div>
            {(type === "register") ? 
              <div className="col-8 mt-1">
                ...
                <Form.Control id="re-email" className="border border-2 border-dark mb-1" placeholder="repeatyourpassword..."/>
